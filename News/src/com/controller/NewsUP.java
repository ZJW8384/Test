...
@WebServlet("/newsUP")
public class NewsUP extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        NewsAService newsA=new NewsAService();
        AllNews nad=new AllNews();
        try {
            newsA.upnews(sub,title,top,writer,des,msg,img);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            List<NewsInfo> list=nes.newOne(title);
            req.setAttribute("list",list);
            req.getRequestDispatcher("/jsp/editnews.jsp").forward(req,resp);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
